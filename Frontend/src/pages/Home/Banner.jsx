        ...
        <div className=' bg-teal-100  px-4 lg:px-24 flex items-center'>
            <div className='flex flex-col md:flex-row-reverse justify-between items-center gap-12 py-40'>
                ...
                <div className='md:w-1/2 space-y-8 bg-teal-100'>
                    <h1 className='lg:text-6xl text-5xl font-bold text-black mb-5 lg:leading-tight leading-snug'>Unlock the World of Books: <span className='text-blue-700'> Your Local Library</span></h1>
                    <p>Reserve your literary adventures at the tap of a button—always securing your next captivating read.</p>
                    <div>
